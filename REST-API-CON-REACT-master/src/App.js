...
function App() {
  ...
  return (
    ...
    <div className="flex space-x-4">
        <div className="flex-none sticky top-0 z-10"> {/* Formulario fijo en la parte superior */}
            <Form alumno={alumno} setAlumno={setAlumno} />
        </div>
        <div className="flex-grow overflow-y-auto max-h-screen"> {/* La tabla ocupa el resto y permite scroll */}
